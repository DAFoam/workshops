...
defineTypeNameAndDebug(DASimpleFoamNew, 0);
addToRunTimeSelectionTable(DASolver, DASimpleFoamNew, dictionary);
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

DASimpleFoamNew::DASimpleFoamNew(
    char* argsAll,
    PyObject* pyOptions)
...
void DASimpleFoamNew::initSolver()
{
    /*
    Description:
    ...
    */
    ...
    Info << "Initializing fields for DASimpleFoamNew" << endl;
    Time& runTime = runTimePtr_();
    fvMesh& mesh = meshPtr_();
#include "createSimpleControlPython.H"
#include "createFieldsSimpleNew.H"
...
label DASimpleFoamNew::solvePrimal(
    const Vec xvVec,
    Vec wVec)
{
    /*
...
#include "setForwardADSeeds.H"
    ...
    while (this->loop(runTime)) // using simple.loop() will have seg fault in parallel
    {
        ...
        {
#include "UEqnSimpleNew.H"
#include "pEqnSimpleNew.H"
        }
    ...
    Info << "This is DASimpleFoamNew test " << endl;
